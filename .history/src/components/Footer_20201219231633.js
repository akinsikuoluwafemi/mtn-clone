    ...
    return (
      <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-12 bg-success footer-logos">
              ...
              <div>
                ...
                <small>Privacy Policy & Data Protection</p>
              </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12 bg-info">
                   <SelectCountry/>     
            </div>
          </div>
        </div>
