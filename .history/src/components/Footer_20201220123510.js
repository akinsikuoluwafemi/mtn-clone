    ...
    return (
      <div className="container footerr-wrapper ">
        ...
        <div className="row footer-bottom ">
          <div className="col-md-6 footer-bottom-first-content col-lg-4  bg-info">
            <div className="icons">
              <span>
          ...
          <p className="text-white">&nbsp; 2020 MTN Nigeria Communications PLC, All rights reserved. </p>
          <div className="col-md-6 col-lg-4  bg-danger">col1</div>
        </div>
