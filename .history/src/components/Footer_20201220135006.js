      ...
      <div className="container footerr-wrapper ">
        ...
        <div className="row footer-bottom ">
          <div className="col-md-6 col-lg-4  ">
            <div className="icons icons-down">
              <span>
            ...
            <p style={{color: "#666"}} className=" my-3 h5">
              &nbsp; 2020 MTN Nigeria Communications PLC, All rights reserved.{" "}
            </p>
            <p style={{color: "#666"}} className=" h6">Privacy Policy & Data Protection</p>
          </div>
          <div className="col-md-6 col-lg-4 footerr-country-select  "><SelectCountry/></div>
        </div>
