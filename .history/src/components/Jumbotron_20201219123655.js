        ...
        <div className="curved">
          ...
          <div className="container jumbotron-center">
                <div class="jumbotron-center-content">
                        <div className=" jumbotron-center-content-head text-white">
                            <p style={{fontWeight: '500', color: '#fff', fontSize: '2.5rem'}}>Contact</p>
                            
                            <p  className="header-text">MT Suppliers</p>
