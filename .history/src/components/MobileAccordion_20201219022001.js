...
export default function MobileAccordion() {
    ...
    return (
      <div>
        ...
        <div class="accordion">
          <span className="accordion-summary">Foundation</span>
        </div>
        <div class="accordion">
          {" "}
          <span className="accordion-summary">Events</span>
        </div>
        ...
        <div class="accordion">
          <span className="accordion-summary">About Us</span>
        </div>
        <div class="accordion">
          <span className="accordion-summary">Careers</span>
        </div>
        <div onClick={handleContactChange} class="accordion">
          <span>
            <span className="accordion-summary">Contact Us</span>Contact Us
          </span>
          {contact ? (
            <RemoveIcon fontSize="large" />
          ) : (
