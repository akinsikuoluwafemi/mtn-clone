...
export default function MobileAccordion() {
    ...
    return (
      <div>
        ...
        <div className="accordion-search-container">
            <input type="search" placeholder="search" className="accordion-search-input"/> 
                
        </div>
        <div className="accordion-search-container">
            <select type="search" placeholder="search" className="accordion-search-input"/> 
