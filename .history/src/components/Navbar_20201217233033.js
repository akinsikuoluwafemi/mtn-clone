                    ...
                    <a  href=".">Services </a> <i class="fas fa-angle-right"></i>
                        ...
                        <div className="sub-menu-5">
                            ...
                            <li className="services-menu sub-menu-5-container-list">
                                <a href=".">Tariff Plans </a> <i class="fas fa-angle-right"></i>

                                                
                            </li>
                            <li>
                                <a href=".">Roaming</a> <i class="fas fa-angle-right"></i>
                            </li>
                            <li>
                                <a href=".">International Rates</a> <i class="fas fa-angle-right"></i>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href=".">Recharge</a> <i class="fas fa-angle-right"></i>
                            </li>
                            <li>
                                <a href=".">Sim Services</a> <i class="fas fa-angle-right"></i>
                            </li>
                            </ul>
                        </div>
