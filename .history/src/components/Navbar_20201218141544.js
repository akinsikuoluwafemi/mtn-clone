      ...
      <>
        <nav className="menu-bar">
          <div className="menu-bar-container">
            ...
            <ul className="search-container menu-bar-container-second-list text-center">
          ...
          <div className="mobile-menu-header">
            ...
            <div className={menuOpen ?  `mobile-menu-bar-content show-content` : `mobile-menu-bar-content remove-content`}>
                <div className={menuOpen ? `show`: `not-show`}>
                        <p>MTN has a responsibility to ensure that our business practices are conducted according to local and international laws, and adhere to the highest levels of ethical and moral conduct.

                                We embrace this across all parts of our business, and we expect the same from our suppliers. The Supplier Code of Conduct sets out our approach to ethical and sustainable business prac</p>   
